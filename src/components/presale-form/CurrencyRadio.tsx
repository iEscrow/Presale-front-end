...
const CurencyRadio = ({ token, iconURL }: Props) => {
  ...
  return (
    <label 
      className="flex-[1_1_0] inline-flex items-center justify-center px-2 py-2 sm:py-3 md:px-12 md:py-4 rounded-lg border-[1px] border-bg-logo cursor-pointer hover:bg-bg-logo hover:border-bg-logo has-[:checked]:bg-bg-logo has-[:checked]:border-bg-logo duration-200 group select-none" 
    >
      <input 
